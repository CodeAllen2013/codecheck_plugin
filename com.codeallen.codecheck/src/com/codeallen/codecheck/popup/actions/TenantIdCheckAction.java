...
public class TenantIdCheckAction implements IObjectActionDelegate {
	      ...
	      throws CoreException
	    {
	      for (IProject configurationTarget : this.mProjectsToActivate)
	      {
	        if ((!(configurationTarget.isOpen())) || 
	          (configurationTarget.hasNature("com.codeallen.codecheck.CodeCheckNature")))
	          continue;
	        ConfigureDeconfigureNatureJob job = new ConfigureDeconfigureNatureJob(
	          configurationTarget, "com.codeallen.codecheck.CodeCheckNature");
	        job.schedule();
	      }
